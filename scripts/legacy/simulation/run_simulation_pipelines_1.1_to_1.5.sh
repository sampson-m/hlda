...
SIM_CONFIGS=(
  ...
  "data/ABCD_V1V2 estimates/ABCD_V1V2 6_topic_fit 4 ABCD_V1V2 2 6"
)
...
for CONFIG in "${SIM_CONFIGS[@]}"; do
  ...
  # Only process DE_mean 1.1 to 1.5
  for DE_MEAN in "DE_mean_1.1" "DE_mean_1.2" "DE_mean_1.3" "DE_mean_1.4" "DE_mean_1.5"; do
...
echo "\nAll simulation pipelines complete for DE_mean 1.1 to 1.5!" 